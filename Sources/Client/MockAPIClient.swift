...
public struct MockAPIClient<K: Sendable & Codable>: APIClientKind {
    ...
    public func data<T, Body, Query, Error>(_ path: String, method: EndpointMethod, query: Query, body: Body, errorType: Error.Type, decodingAs type: T.Type) async throws(APIClientError<Error>) -> T
    where T: Decodable, T: Encodable, Body: Encodable, Query: Encodable, Error: CodableError {
